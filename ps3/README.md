...
| File | What |
|---|---|
| `CPH200C_PS3_Chambers-Wei.pptx` | **The talk** (~10 min, current slot). 24 slides (15 core content + an "Asia beyond China" supplement + 6 section dividers + cover + thanks), clinical-AI-centered, organized by the four axes → synthesis. Broad-over-deep cut: keeps the intro pair, both chip-war slides, a US-AI-buildout scale slide (AI infra ≈ 1.6% of GDP vs historical buildouts, after Tunguz / Theory Ventures), the US frontier-standing slide (Opus 4.8 / GPT-5.5 / Gemini 3.1 on top; China a cheap, open fast-follower), the real-world deployed comparison (Aidoc / Viz.ai · Oxipit ChestLink · Infervision / Ant AQ / DeepSeek-R1), and ROI. The funding slide carries a China state-capital caveat (~$900B guidance funds + ~$138B national fund, beyond the private-investment chart). "Asia beyond China" (India / Korea / Japan / SE-Asia) is now an end **Supplement** (backup). The Scale-vs-constraint slide is US-vs-China only (dropped the forced EU/ASML band, per Curtis). Trims the two deepest methodology slides (clinical-AI measurement; clinician-AI interaction), which remain in the 15-min variant and the report. Speaker notes embedded in the PowerPoint notes pane. |
