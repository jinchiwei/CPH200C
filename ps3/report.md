...
With no comprehensive federal framework, individual states legislated, producing a patchwork: Colorado's AI Act (delayed to June 2026), Texas TRAIGA (effective January 2026), California's SB 53 Transparency in Frontier AI Act (the lighter successor to the vetoed SB 1047), and New York's RAISE Act (Mintz 2025; NY Governor 2025). The federal response has been preemptive: a proposed moratorium on state AI laws failed in the Senate by 99 to 1, after which a December 2025 executive order directed federal agencies to challenge "burdensome" state statutes (StateScoop 2025; Akin Gump 2025). The most recent federal action, a June 2026 executive order titled "Promoting Advanced Artificial Intelligence Innovation and Security," asks frontier developers to voluntarily grant the government up to 30 days of pre-release access to NSA-designated "covered frontier models" and stands up a Treasury-run "AI cybersecurity clearinghouse," while explicitly prohibiting any mandatory licensing or pre-clearance (White House 2026c). Notably, it is voluntary, national-security-framed, and silent on healthcare, confirming that even the federal government's only frontier-model touch is a light, security-oriented one rather than a regulatory or clinical pathway. The net posture is a light federal touch, a thickening state patchwork, and an unresolved fight over who governs AI.
...
- White House, "Promoting Advanced Artificial Intelligence Innovation and Security" (Jun 2026c). https://www.whitehouse.gov/presidential-actions/2026/06/promoting-advanced-artificial-intelligence-innovation-and-security/
...
- Tom's Hardware, "Huawei chairman thanks the US for export restrictions, says it supercharged China's semiconductor industry" (2026). https://www.tomshardware.com/tech-industry/huawei-chairman-thanks-the-us-for-supercharging-chinas-semiconductor-industry
- South China Morning Post, "Is Huawei's new chip scaling law a true breakthrough, or mere hype?" (2026). https://www.scmp.com/tech/tech-trends/article/3355314
...
- Artificial Analysis, frontier model intelligence leaderboard (2026). https://artificialanalysis.ai/
- Epoch AI, US-China model capability gap and notable-model counts (2026). https://epoch.ai/data
- DeepSeek-AI, "DeepSeek-V4 Technical Report" (2026). arXiv preprint.
...
- Aidoc, deployed radiology and acute-care AI (1,600+ centers, 100M+ cases) (2026). https://www.aidoc.com/
- Viz.ai, stroke-detection deployment network (~1,800 hospitals) (2026). https://www.viz.ai/
- Oxipit (now part of Sectra), ChestLink autonomous chest X-ray reporting (CE Class IIb) (2025). https://oxipit.ai/
